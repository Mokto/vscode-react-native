    ...
    suite("debuggerContext", function() {
        ...
        setup(() => {
            ...
            androidPlatform = new AndroidPlatform({
                ...
                extensionMessageSender: fakeExtensionMessageSender,
            });
        ...
        testWithRecordings("runApp launches the app when a single emulator is connected",
            [
                "react-native/run-android/win10-rn0.21.0/succedsWithOneVSEmulator",
                "react-native/run-android/win10-rn0.22.2/succedsWithOneVSEmulator",
                "react-native/run-android/osx10.10-rn0.21.0/succedsWithOneVSEmulator",
            ], () => {
                return Q({})
                    .then(() => {
        ...
        testWithRecordings("runApp launches the app when two emulators are connected",
            ["react-native/run-android/win10-rn0.21.0/succedsWithTwoVSEmulators"], () => {
                return Q({})
                    .then(() => {
        ...
        testWithRecordings("runApp launches the app when three emulators are connected",
            ["react-native/run-android/win10-rn0.21.0/succedsWithThreeVSEmulators"], () => {
                return Q({})
                    .then(() => {
        ...
        testWithRecordings("runApp launches the app in an online emulator only",
            ["react-native/run-android/win10-rn0.21.0/succedsWithFiveVSEmulators"], () => {
                return Q({})
                    .then(() => {
        ...
        testWithRecordings("runApp launches the app in a random online device if the target is offline",
            ["react-native/run-android/win10-rn0.21.0/succedsWithTenVSEmulators"], () => {
                return Q({})
                    .then(() => {
                        return simulatedAVDManager.createAndLaunchAll("Nexus_5", "Nexus_6", "Nexus_10", "Nexus_11", "Nexus_12",
